...
**Home Roost** (album-home-roost.html) is the evergreen everyday-lab-life album: photos dropped into `../album-originals/Everyday_Lab_Life/` get APPENDED (renumber, bump counts, update sitemap).
